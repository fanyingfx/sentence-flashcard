...
from .mdxcrypt.ripemd128 import ripemd128
from .mdxcrypt.pureSalsa20 import Salsa20
...
class MDict(object):
    ...
    def _decode_key_block_info(self, key_block_info_compressed):
        if self._version >= 2:
            ...
            if self._encrypt & 0x02:
                ...
                key_block_info_compressed = key_block_info_compressed[:8] + _fast_decrypt(key_block_info_compressed[8:],
                                                                                          key)
            # decompress
    ...
    def _read_header(self):
        ...
        self._stylesheet = json.dumps(_stylesheet, ensure_ascii=False)
